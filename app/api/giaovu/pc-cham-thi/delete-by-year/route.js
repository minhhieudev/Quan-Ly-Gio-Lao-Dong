...
export const DELETE = async (req) => {
 ...
 // Lấy dữ liệu từ request body
    const { namHoc, loai, hocKy, loaiKyThi } = await req.json();
    console.log(namHoc, loai, hocKy, loaiKyThi);
    ...
    const countBeforeDelete = await PcChamThi.countDocuments(filter);
    ...
    const deleteResult = await PcChamThi.deleteMany(filter);
    ...
    console.error("Error deleting PcChamThi by year:", err);
