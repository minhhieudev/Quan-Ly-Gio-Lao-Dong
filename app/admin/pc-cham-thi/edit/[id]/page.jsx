          ...
          <Col span={12}>
            ...
            >
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    placeholder="Nhập mã học phần, cách nhau bởi dấu phẩy"
                    {...field}
                  />
                )}
              />
          ...
          <Col span={12}>
            ...
            >
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    placeholder="Nhập nhóm lớp, cách nhau bởi dấu phẩy"
                    {...field}
                  />
                )}
              />
          ...
          <Col span={8}>
            ...
            >
              <Controller
                ...
                render={({ field }) => (
                  <Input placeholder="Nhập năm học..." {...field} />
                )}
              />
            </Form.Item>
          </Col>
          ...
          <Col span={8}>
            ...
            >
              <Controller
                ...
                render={({ field }) => (
                  <Select placeholder="Đợt thi..." {...field}>
