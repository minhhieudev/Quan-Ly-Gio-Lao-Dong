...
const TeachingAssignmentForm = () => {
  ...
  return (
    <div>
      <div className="p-4 bg-white shadow-lg rounded-lg mt-3 w-[70%] mx-auto"></div>
      ...
      <Form onFinish={handleSubmit(onSubmit)} layout="vertical" className="space-y-2 font-bold">
        <Row gutter={16}>
          <Col span={12}>
            <Form.Item label="Mã học phần" validateStatus={errors.maHP ? 'error' : ''} help={errors.maHP?.message}>
              <Controller
                name="maHP"
                control={control}
